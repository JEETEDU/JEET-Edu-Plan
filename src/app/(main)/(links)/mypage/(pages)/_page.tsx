    ...
    function Buttons() {
        return (
            <div className="flex flex-row gap-4">
                <button
                    className="px-3 py-1 bg-red-500 text-white font-bold rounded lg:lg:hover:bg-red-600 w-fit"
                    onClick={logout}
                >
                    로그아웃
                </button>
            ...
            <div className="w-full h-full flex flex-col items-center bg-gray-100">
                <div className="w-full flex flex-row justify-between items-center py-3 px-6">
                    <div className="flex items-center gap-4">
                        {!isMobile && (
                            <button
                                className="p-2 rounded text-lg font-bold bg-gray-500 text-white lg:lg:hover:bg-gray-600"
