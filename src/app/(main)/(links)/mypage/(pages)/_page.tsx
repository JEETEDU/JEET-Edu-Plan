            ...
            {(showBanner) && (
                ...
                >
                    ...
                    <div
                        ...
                        className="bg-gray p-1 rounded flex flex-row gap-4 justify-center items-center"
                    >
                        {(userType === 3) && (
                            <div
                        ...
                        <div
                            className="px-2 py-1 rounded bg-white font-bold border-2 border-red hover:bg-red hover:text-white cursor-pointer"
                    ...
                    <div className="max-h-full grow max-w-full" style={{aspectRatio: banner.width / banner.height}}>
                        <div
