                ...
                <div className="flex flex-col w-full gap-2">
                    {todos.map((todo) => (
                        ...
                        >
                            <div
                                className={cn(
                                    ...
                                    (todo.done === 1) ? "bg-green-500 border-green-500 text-white"
                                        : "",
                                    (!isMobile) ? (todo.done === 1) ? "md:hover:bg-red-500 md:hover:border-red-500" : "md:hover:bg-blue md:hover:border-blue md:hover:text-white" : ""
                                )}
                                onClick={async () => {
                                    if (todo.done === 0) {
                            ...
                            <div className={cn("flex-1 border-y-2 border-r-2 rounded-r flex p-2 gap-2 md:hover:bg-white items-center", isMobile ? "flex-col" : "flex-row")}>
                                <TextareaAutosize
