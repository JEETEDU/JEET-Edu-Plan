    ...
    return (
        ...
        >
            ...
            <div className={cn("grid w-full", isMobile ? "grid-cols-2" : "grid-cols-4 gap-4")}>
                {(!isMobile) && (
                    <div
                        className="flex items-center justify-center text-center bg-green-500 md:hover:bg-green-600 text-white py-1 rounded"
                        onClick={() => setStartDueDateAction(null)}
                    >
                        시작 날짜 제거
                    </div>
                ...
                <div className="flex flex-col w-full gap-2">
                    {homeworks.map((homework, index) => (
                        ...
                        >
                            <div
                                className={cn(
                                    ...
                                    (homework.done === 1) ? "bg-green-500 border-green-500 text-white"
                                        : "",
                                    (!isMobile) ? (homework.done === 1) ? "md:hover:bg-red-500 md:hover:border-red-500" : "md:hover:bg-blue md:hover:border-blue md:hover:text-white" : "",
                            ...
                            <div
                                className={cn("flex-1 border-y-2 border-r-2 rounded-r flex flex-row p-2 gap-2 md:hover:bg-white items-center", {"border-black": (homework.article_id === head)})}
                                onClick={() => {
                                    if (isMobile) {
