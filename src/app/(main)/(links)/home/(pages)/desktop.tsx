                    ...
                    <div className="bg-gray-100 grid grid-cols-3 w-full items-center">
                        ...
                        <div className="flex justify-center">
                            <div className={cn("p-0 pointer-events-auto component-form items-center whitespace-nowrap", " grid grid-cols-3")}>
                                <button
                                    className={cn(
                                        (tab === 0) ? "bg-white pointer-events-none" : "bg-gray-300 md:hover:bg-gray-200 transition duration-200",
                                    ...
                                    className={cn(
                                        {
                                            ...
                                            "bg-gray-300 md:hover:bg-gray-200 transition duration-200": (tab !== 1),
                                        },
                                    ...
                                    className={cn(
                                        {
                                            ...
                                            "bg-gray-300 md:hover:bg-gray-200 transition duration-200": (tab !== 2),
                                        },
