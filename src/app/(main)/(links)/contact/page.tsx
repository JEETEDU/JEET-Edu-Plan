                            ...
                            <div className="flex flex-col flex-1 items-center justify-end gap-1">
                                <div className="flex flex-row w-full items-center justify-center gap-2">
                                    ...
                                    <div className="flex flex-col flex-1 text-blue-400 hover:text-blue-600">
                                        <a href="mailto:dev@hegelty.me">dev@hegelty.me</a>
                                    </div>
                                </div>
                                <div className="flex flex-row w-full items-center justify-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <div className="flex flex-col flex-1 text-blue-400 hover:text-blue-600">
                                        <a href="https://github.com/hegelty">github.com/hegelty</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={cn(notoSerifKr.className, "flex-1 h-full flex flex-col justify-center col-span-2")}>
                            ...
                            <div className="flex flex-col flex-1 items-center justify-end gap-1">
                                <div className="flex flex-row w-full items-center justify-center gap-2">
                                    ...
                                    <div className="flex flex-col flex-1 text-blue-400 hover:text-blue-600">
                                        <a href="mailto:seoho7777.kim@gmail.com">seoho7777.kim@gmail.com</a>
                                    </div>
                                </div>
                                <div className="flex flex-row w-full items-center justify-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <div className="flex flex-col flex-1 text-blue-400 hover:text-blue-600">
                                        <a href="https://github.com/seohokim-hoya">github.com/seohokim-hoya</a>
                                    </div>
                                </div>
                            </div>
                        </div>
