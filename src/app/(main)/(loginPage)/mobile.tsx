    ...
    return (
        <div className="component-container h-full px-1/6">
            <div className="grid grid-cols-2 component-form mb-4 p-0">
                <button
                    className={cn({"bg-white pointer-events-none": isLogin, "bg-gray-300 md:hover:bg-gray-200 transition ": !isLogin}, "h-fit rounded-l-lg text-center p-1")}
                    onClick={() => {
                        setIsLogin(true);
                ...
                <button
                    className={cn({"bg-white pointer-events-none": !isLogin, "bg-gray-300 md:hover:bg-gray-200 transition ": isLogin}, "h-fit rounded-r-lg text-center p-1")}
                    onClick={() => {
                        setIsLogin(false);
                        setError({message: "", color: ""})
                    }}
