 ...
 *      description: <b>Admin</b><br>Quit student from the class
 *      requestBody:
 *          required: true
 *          content:
 *              application/json:
...
export async function POST(req: NextRequest) {
    try {
        return db.transaction(async (tx) => {
            ...
            await db_log(tx, decoded.user_id, `User ${class_.student_class.user_id} quit class ${class_.class_info.id}(name: ${class_.class_info.name})`);
