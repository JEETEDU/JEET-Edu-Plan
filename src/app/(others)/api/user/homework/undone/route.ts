...
/**
 * @swagger
 * /api/user/homework/undone:
 *   put:
 *     summary: Updates a user's homework status to "incomplete".
 *     description: Marks a homework item as "incomplete" for a student based on the given `article_id`. The user must be logged in and have permission to update it.
 *     tags:
 *       - Homework
 *     requestBody:
 *       required: true
