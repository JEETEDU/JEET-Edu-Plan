...
export default defineConfig({
    ...
    shortcuts: {
        ...
        "nav-item":
            cn("h-fit px-2 w-full min-w-fit content-center text-gray-700 dark:text-gray-300 lg:lg:hover:text-blue-500 grid place-items-center"),
        "_nav-item":
        ...
        "component-button":
            "cursor-pointer bg-blue-500 text-white w-fit py-1 px-3 rounded lg:lg:hover:bg-blue-600 transition duration-200 dark:bg-blue-700 dark:lg:lg:hover:bg-blue-800 text-center bg-blue-500 lg:lg:hover:bg-blue-600 text-white py-1 transition duration-200 items-center flex justify-center",
